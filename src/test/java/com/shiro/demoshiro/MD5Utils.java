...
public class MD5Utils {
    ...
    public static String getSaltMD5(String password) {
        ...
        System.out.println("原始数据:" + password);
    ...
    public static void main(String[] args) {
        ...
        Md5Hash md5 = new Md5Hash("123456","111111",2);
        System.out.println(md5.toString());
        SimpleHash hsah = new SimpleHash("MD5","123456","111111",2);
        System.out.println(hsah.toString());
